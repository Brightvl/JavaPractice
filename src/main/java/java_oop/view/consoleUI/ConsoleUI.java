package java_oop.view.consoleUI;

import java_oop.model.members.Gender;
import java_oop.model.members.Human;
import java_oop.model.members.Member;
import java_oop.presenter.Presenter;
import java_oop.view.View;
import java_oop.view.consoleUI.input.InputReader;
import java_oop.view.consoleUI.menu.allRecordsMenu.AllRecordsMenu;
import java_oop.view.consoleUI.menu.endMenu.EndMenu;
import java_oop.view.consoleUI.menu.mainMenu.MainMenu;
import java_oop.view.consoleUI.menu.recordMenu.RecordMenu;
import java_oop.view.consoleUI.menu.sortingMenu.SortingMenu;
...
//        work = true;
    ...
    public void importFile() {
        while (!presenter.isImportFileLoaded()) {
            presenter.importFile(input.inputLn(
                    "Укажите путь к файлу типа Human для загрузки (Пример: src/main/java/java_oop/ruriksTree.bin)"));
        }
    }
