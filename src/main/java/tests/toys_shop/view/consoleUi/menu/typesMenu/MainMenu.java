...
import tests.toys_shop.view.consoleUi.menu.commands.AddToy;
import tests.toys_shop.view.consoleUi.menu.commands.CloseProgram;
import tests.toys_shop.view.consoleUi.menu.commands.ShowToys;
