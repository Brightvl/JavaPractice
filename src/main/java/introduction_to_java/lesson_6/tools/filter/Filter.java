package introduction_to_java.lesson_6.tools.filter;
...
import static introduction_to_java.lesson_6.tools.filter.сategoriesLaptop.FilterManufacture.*;
import static introduction_to_java.lesson_6.tools.filter.сategoriesLaptop.FilterCategory.*;
import static introduction_to_java.lesson_6.tools.filter.сategoriesLaptop.FilterOS.*;
import static introduction_to_java.lesson_6.tools.filter.сategoriesLaptop.FilterScreenSize.*;
