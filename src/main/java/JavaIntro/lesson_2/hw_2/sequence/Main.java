package JavaIntro.lesson_2.hw_2.sequence;


import java.util.Arrays;
import java.util.Scanner;

import static JavaIntro.lesson_2.hw_2.sequence.T1_SumPrimeNumber.MarkerPrimeNumber;
import static JavaIntro.lesson_2.hw_2.sequence.T1_SumPrimeNumber.SumPrimeNumbers;
import static JavaIntro.lesson_2.hw_2.sequence.T2_SequenceCheck.AscendingSequenceCheck;
import static JavaIntro.lesson_2.hw_2.sequence.T3_EditingSequences.GeneratorSequence;
import static JavaIntro.lesson_2.hw_2.sequence.T3_EditingSequences.ReplacingNegatives;
